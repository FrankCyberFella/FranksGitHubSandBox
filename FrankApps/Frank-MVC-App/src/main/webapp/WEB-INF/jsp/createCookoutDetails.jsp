...
<c:url var="createCookoutDetailUrl" value="/createCookoutDetails" />
<form:form action="${createCookoutDetailUrl}" method="POST" modelAttribute="cookout">
<input type="hidden" name="CSRF_TOKEN" value="${CSRF_TOKEN}" />


		<div>
			<label for="cookoutName">Event Name:</label><br> 
			<form:input type="text" path="cookoutName" id="cookoutName" size="45" placeholder="Event Name" required="required" />
		...
		<div><br>
			...
			<form:input type="text"
				path="zip" id="zip" size="45" pattern="[0-9]{5}" required="required" title="Enter a 5 digit zip code"/>
