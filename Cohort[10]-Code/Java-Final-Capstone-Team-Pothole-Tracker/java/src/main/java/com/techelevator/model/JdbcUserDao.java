...
public class JdbcUserDao implements UserDao {
    ...
    public User saveUser(String userName, String password, String role) {
        ...
        long newId = jdbcTemplate.queryForObject("INSERT INTO site_user(username, password_hash, salt, role) VALUES (?, ?, ?, ?) RETURNING user_id", Long.class, userName,
    ...
    public User getValidUserWithPassword(String userName, String password) {
        String sqlSearchForUser = "SELECT * FROM site_user WHERE UPPER(username) = ?";
    ...
    public List<User> getAllUsers() {
        ...
        String sqlSelectAllUsers = "SELECT id, username, role FROM site_user";
