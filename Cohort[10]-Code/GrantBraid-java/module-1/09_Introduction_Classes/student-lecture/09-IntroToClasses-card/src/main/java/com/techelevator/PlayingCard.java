...
//<<<<<<< HEAD
	...
	//ctor to create a card with suit, value, image and shape
	...
	private void determineColor(String suit) {
		...
		if (suit.toLowerCase().equals("clubs") || suit.toLowerCase().equals("spade")) {
			color = "black";
		} else if (suit.toLowerCase().contentEquals("hearts") || suit.toLowerCase().equals("diamond")){
			color = "red";
		} else {
			color = "unknown";
		}
