...
reviewDesc.addEventListener('click', (event) => {
  changeDescription(event.target)   // call our function passing it the element that experience the event
});
...
function changeDescription(reviewDesc) {
  ...
  const textBox = reviewDesc.nextElementSibling;  // get a reference to elem to change
