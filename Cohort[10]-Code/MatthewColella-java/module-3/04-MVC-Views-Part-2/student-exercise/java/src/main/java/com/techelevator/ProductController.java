...
public class ProductController {
																//URL path this code will handle
	@RequestMapping("/")										//Receives the request from the server
	public String handleRootPath(HttpServletRequest request) {	//Create an entry in request with return of getProducts
		request.setAttribute("productList", getProducts());		//Run productList.jsp
		return"productList";									//return the name of the .jsp file to run for this controller
	}
	...
	//Model is an ArrayList here but it could be other things
