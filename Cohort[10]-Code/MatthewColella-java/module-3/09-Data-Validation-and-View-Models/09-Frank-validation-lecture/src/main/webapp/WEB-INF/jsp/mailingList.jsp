...
<form:form action="${mailingListSignUpUrl}" method="POST" modelAttribute="SignUp">
 ...
 <!-- class="form-control" means it's a text box, use instead of type="text" -->
        	<form:errors path="name" cssClass="error" />
 <!-- with form:form, you use path= to identify the the variable in the model backing the form -->
 <!-- path = instead on name=, because you're referencing the model that's been set up to back this form -->      		
        </div>
        <div>
