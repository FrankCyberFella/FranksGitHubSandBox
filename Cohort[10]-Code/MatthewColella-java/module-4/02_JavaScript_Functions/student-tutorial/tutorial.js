 ...
 */
 ...
 /**
  * takes in a temperature number,  a temperature scale (F or C), and
  * an includeUnit boolean. returns the temperature of the opposite scale
  * and the F or C letter if the includeUnit boolean is true.
  * 
  * @param {number} temperature temperature value to input
  * @param {string} temperatureUnit temperature scale of the temperature value
  * @param {boolean} includeUnit whether to include the scale symbol (C or F) in the returned string
  */
