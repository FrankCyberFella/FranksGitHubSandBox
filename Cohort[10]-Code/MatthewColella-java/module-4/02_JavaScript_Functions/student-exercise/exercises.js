 ...
 */
 ...
 /**
  * takes in a month, day, and a hemisphere, and if the month and day
  * fall in summer for either hemisphere, it will check if these
  * days are valid in the hemisphere specified. It does this by
  * saying hemisphere === hemipshere parameter and if it is true,
  * it will return torue and if not it will return false.
  * 
  * @param {*} month 
  * @param {*} day 
  * @param {*} hemisphere 
 ...
 */
 ...
 function getFullAddressesOfProperties(arrays){
   return arrays.map((address) => {
     return Object.values(address).reduce((words, word) => {
        return words + word;
     });
    })
