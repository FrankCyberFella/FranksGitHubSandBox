...
public class BuyoutAuction extends Auction {
	...
	public BuyoutAuction(String itemForSale, int buyoutPrice) {
		...
		// superclass data so you have to use a superclass ctor, once it runs the ctor it can know the itemForSale, etc.
	...
	public boolean placeBid(Bid offeredBid) {
		...
		if(getHighBid().getBidAmount() < buyoutPrice) {
			...
			isCurrentWinningBid = super.placeBid(offeredBid);//runs the super class placeBid method
		}
