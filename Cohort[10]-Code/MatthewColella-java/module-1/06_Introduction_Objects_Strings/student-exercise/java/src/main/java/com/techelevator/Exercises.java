...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		String subsA = a.substring(1, a.length());
		String subsB = b.substring(1, b.length());
		return subsA + subsB;
	...
	public String left2(String str) {
		...
		String theRest = str.substring(2, str.length());
	...
	public String middleThree(String str) {
		int firstOfMiddle = (str.length() / 2) - 1;
		return str.substring(firstOfMiddle, firstOfMiddle + 3);
	}
	...
	public String frontTimes(String str, int n) {
		...
		for (int i = 0; i < n; i++) {
			if (str.length() <= 3) {
				...
				strTotal = strTotal + str.substring(0, 3);
		}
		return strTotal;
	}
	...
	public String stringX(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if (str.substring(i, i + 1).equals("x") && i > 0 && i < str.length() - 1) {
				...
				total = total + str.substring(i, i + 1);
		}
