...
@Override // - Annotation that tells compiler make sure I am overriding an existing method
// Annotation is a direction to the compiler - all start with an @ 
...
public String toString() {
	...
	if(value > 10) {
		card += "     Card value: " + this.getValueName() + "\n";
	} else {
	card += "     Card value: " + value + "\n";
	}
	card += "Card is face up: " + faceUp + "\n";
	return card;
}
