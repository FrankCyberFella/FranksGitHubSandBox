...
public class Exercises {
	...
	public String extraEnd(String str) {
		int strL = str.length();
		String lastTwo = str.substring(strL-2);
	...
	public String firstHalf(String str) {
		int strL = str.length();
		String halfStr =  str.substring(0,(strL/2));
		return halfStr;
	}
	...
	public String right2(String str) {
		int strL = str.length();
		return str.substring(strL-2) + str.substring(0,strL-2);
	}
	...
	public String nTwice(String str, int n) {
		int strL = str.length();
		return str.substring(0,n) + str.substring(strL-n);
	}
	...
	public String middleThree(String str) {
		int strL = str.length();
		int strM = str.length()/2;
		if(strL == 3) {
			return str;
		}
		return str.substring(strM-1, strM+2);
	}
	...
	public boolean hasBad(String str) {
		...
		if(strL >= 3) {
			if(strL > 4) {
				...
				return str.substring(0).contains("bad");				
		}
		return false;
	}
