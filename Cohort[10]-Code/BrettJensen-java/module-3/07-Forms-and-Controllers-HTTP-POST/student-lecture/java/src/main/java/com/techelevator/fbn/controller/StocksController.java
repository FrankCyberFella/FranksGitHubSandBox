...
@Controller
@RequestMapping("/fbn")
@SessionAttributes("stocks")			// This data item should persist across sessions - instead of deleting at end of request
										//will exist as long as browser session is active
public class StocksController {			
	@RequestMapping(path={"/stocks"}, method=RequestMethod.GET)
	public String showStocksPage(ModelMap map){	// ModelMap - user defined Map.... Model - user defined piece of data
