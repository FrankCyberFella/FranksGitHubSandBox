...
public class JDBCCityDAOIntegrationTest {
	...
	public void save_new_city_and_read_it_back() throws SQLException {
		...
		assertCitiesAreEqual(theCity, savedCity); // Verify the City retrieved from the table has the same values as what was INSERTed
	}
	...
	public void returns_cities_by_country_code() {
		...
		assertCitiesAreEqual(theCity, savedCity); // Verify the City retrieved is the one created and saved
	}
