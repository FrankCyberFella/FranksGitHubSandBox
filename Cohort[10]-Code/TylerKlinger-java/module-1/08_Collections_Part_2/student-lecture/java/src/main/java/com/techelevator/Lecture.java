...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		//Map<String, String> nameToZip = new TreeMap<String, String>(); returns in alphabetical order
...
//2. Use a for-each to go through the Set object -- use the datatype of key as for-each
//3. Inside loop, use the current Set object variable to .get() from the Map
		...
		for(String name : keys) { // loops through set of keys
		System.out.println(name+" lives in "+nameToZip.get(name));//retrieves Map entry for current key
