...
//toString() - convert a PlayCard to String
//an Annotation is a direction to the compiler -- start with @
@Override // Annotation - tells compiler to override existing method
...
public boolean equals(PlayingCard otherCard) {
	System.out.println("PlayingCard equals method is run");
