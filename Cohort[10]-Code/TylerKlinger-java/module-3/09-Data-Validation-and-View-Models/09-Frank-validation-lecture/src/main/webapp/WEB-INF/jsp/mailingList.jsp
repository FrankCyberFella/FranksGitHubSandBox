...
<form:form action="${mailingListSignUpUrl}" method="POST" modelAttribute="SignUp">
        ...
        <div>
        	...
        	<form:input  path="name"  class="form-control"/> <!--  name= identifies the variable in the model backing form -->
        													<!-- class="form-control" - a text box (instead of type=text -->
        ...
        <div>
        	...
        	<form:errors path="emailMatching" cssClass="error"/> <!--  put any error message here -->
        </div>													<!-- cssClass attribute IS the name for the error indicator -->
