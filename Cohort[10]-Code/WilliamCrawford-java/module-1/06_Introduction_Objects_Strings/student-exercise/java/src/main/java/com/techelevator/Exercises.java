...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String wordString = out.substring(0, 2) + word + out.substring(2, 4);
	...
	public String extraEnd(String str) {
		String retStr = "";
			...
			retStr = retStr + str.substring(str.length()-2,str.length()) ;
	...
	public String firstTwo(String str) {
		...
		retStr = retStr + str.substring(0, 2);
	...
	public String firstHalf(String str) {
		String retStr = "";
		retStr = str.substring(0, str.length() / 2);
	...
	public String nonStart(String a, String b) {
		...
		retStr = a.substring(1, a.length()) + b.substring(1, b.length());
	...
	public String left2(String str) {
		...
		String stringResult = str.substring(2, str.length()) + firstTwo;
	...
	public String right2(String str) {
		...
		String stringResult = lastTwo + str.substring(0, str.length() -2);
		//System.out.println(stringResult);
		return stringResult;
	}
	...
	public String middleTwo(String str) {
		...
		retStr = str.substring(str.length() / 2 -1, str.length() / 2 + 1);
	...
	public String nTwice(String str, int n) {
		String retStr="";
		retStr = str.substring(0+n,str.length() - n );
		return retStr;
	}
