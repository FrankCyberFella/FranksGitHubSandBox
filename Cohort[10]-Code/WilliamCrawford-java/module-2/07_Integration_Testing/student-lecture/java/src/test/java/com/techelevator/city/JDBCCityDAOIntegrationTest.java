...
public class JDBCCityDAOIntegrationTest {
	...
	public void save_new_city_and_read_it_back() throws SQLException {
		...
		assertCitiesAreEqual(theCity, savedCity);	// verify the City we retrieved has the same values as what we insert.
	}
	...
	public void returns_cities_by_country_code() {
		...
		assertCitiesAreEqual(theCity, savedCity);	// Verify the City retrieved is the one we created and saved
	}
