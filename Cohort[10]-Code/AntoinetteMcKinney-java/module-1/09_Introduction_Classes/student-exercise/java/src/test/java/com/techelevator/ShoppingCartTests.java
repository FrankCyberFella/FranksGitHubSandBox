...
public class ShoppingCartTests {
	...
	private Method getAveragePricePerItem;
    ...
    public void shoppingCartRequiredMembers() {
        ...
        assertTrue("getTotalNumberOfItems() method needs to return type: double", getTotalNumberOfItems.getReturnType() == Double.TYPE);
        ...
        addItems = SafeReflection.getMethod(klass, "addItems", Double.TYPE, Double.TYPE);
    ...
    public void shoppingCartConstructorTest() {
    	try {
	        ...
	        assertTrue("Initial total number of items should 0", 0.0 == (double)getTotalNumberOfItems.invoke(shoppingCart));
    ...
    public void shoppingCartGetAveragericePerItem() {
    	try {
			ShoppingCart shoppingCart = constructor.newInstance();
			shoppingCart.setTotalAmountOwed(0.0);
			shoppingCart.setTotalNumberOfItems(0.0);
	        ...
	        assertTrue("Total number of items should be 2", 2 == (double)getTotalNumberOfItems.invoke(shoppingCart));
