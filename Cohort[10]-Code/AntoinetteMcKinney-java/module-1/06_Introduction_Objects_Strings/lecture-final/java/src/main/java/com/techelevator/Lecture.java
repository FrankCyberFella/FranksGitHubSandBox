...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		boolean containsHello = hello.contains("Hello");//.contains return true if the string says hello
		...
		System.out.println("ends with lo : "+hello.endsWith("lo")); // will return true because ends with lo
		System.out.println("starts with H : "+hello.startsWith("H"));
		//System.out.println("substring(6,10 : "+hello.substring("lo"));
