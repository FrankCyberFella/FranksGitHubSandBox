...
public class Exercises {
	...
	public boolean monkeyTrouble(boolean aSmile, boolean bSmile) {
		...
		// true both a and b are smiling monkey in trouble.
		// if neither a nor b are smiling monkey are in trouble
		// && or ||
	 ...
	 * negative. posNeg(1, -1, false) → trued ======= return false; }
	 */
...
//  teen 13 && teen 19. it's an or statment 
	public boolean loneTeen(int a, int b) {
		
		if ((a >= 13 && a <= 19) && (b < 13 || b > 19)) {//if a is teen and b is not teen return true
			return true;
		} else if((b >= 13 && b <= 19) && (a < 13 || a > 19)) {//if b is teen and a is not teen return true
			return true;
	 ...
	 * intMax(1, 3, 2) → 3 intMax(3, 2, 1) → 3 <<<<<<< HEAD
	 */
	// a, b, c,
	...
	// a = 10 through 20 b = 10 through 20 return largest.
	...
	// cigars <= 40 && >= 60 weekend !upper bound on cigars - What does inclusive
	// mean
	public boolean cigarParty(int cigars, boolean isWeekend) {
		return cigars> 39 && (isWeekend || cigars < 61);
		
		/*
		 * if (isWeekend == true) { // must have at least 40+, no upperlimit }
		 * 
		 * 
		 * if ((cigars <= 40) && (cigars <= 60)) { return true;} else { return false; }
		 * }
		 */
	}
	...
	public boolean in1To10(int n, boolean outsideMode) {
		if(!outsideMode && (n >= 1 && (n <= 10))) { //return true if n is in the range 1..10, inclusive
			return true;
	...
	public boolean more20(int n) {
		if(n % 20 == 1 || (n % 20 == 2)){// if the number modulus (remainder) 
		return true;	
		}else
			return false;
	}
