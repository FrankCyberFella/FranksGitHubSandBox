...
// Annotation is a direction to the compliler - Start with @

// to String () - convert a PlayCard to a String
...
// No @Override is necessary because the superclass does not have a equals that takes a Playing card asa parameter
public boolean equals(PlayingCard otherCard) {
	if (this.value == otherCard.value 
		&&this.suit == otherCard.suit) { // use .equals
		
		return true; { // use.equals to c
	}
	return false;{
}
