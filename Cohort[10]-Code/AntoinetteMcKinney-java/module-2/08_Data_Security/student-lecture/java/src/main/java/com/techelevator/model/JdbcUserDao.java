...
public class JdbcUserDao implements UserDao {
    ...
    private PasswordHasher passwordHasher; // instanciated a class called passwordHasher, that the class that does all the work
   ...
   //dataTypeis byte array //class is passwordHasher the
        byte[] salt = passwordHasher.generateRandomSalt(); // generates a salt 
        //ComputeHas
        String hashedPassword = passwordHasher.computeHash(password, salt); // the passwordHasher. does all the work 
