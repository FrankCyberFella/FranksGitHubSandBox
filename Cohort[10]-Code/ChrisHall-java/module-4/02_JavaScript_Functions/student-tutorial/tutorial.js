 ...
 */
/** Takes a number and a unit of degrees and converts number to represent the other temperature standard,
 * (F to C, or C to F).  Returns a string representation of degrees and, optionally, the unit of degrees.
 *
 * 
 * @param {number} temperature number of degrees
 * @param {string} temperatureUnit unit of degrees, 'F' or 'C'
 * @param {boolean} includeUnit indicates whether it is necessary to include unit of degrees
 */
