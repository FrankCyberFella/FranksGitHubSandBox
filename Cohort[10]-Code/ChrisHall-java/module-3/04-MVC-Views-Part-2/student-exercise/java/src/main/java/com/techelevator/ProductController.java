...
public class ProductController {
	...
	public String showProductList(HttpServletRequest request) { //receive the request from the server
	...
	}											// Return the name of the .jsp file to run as a String (which is the name of the view)
	...
	// Here the model is an array list--could be other things
