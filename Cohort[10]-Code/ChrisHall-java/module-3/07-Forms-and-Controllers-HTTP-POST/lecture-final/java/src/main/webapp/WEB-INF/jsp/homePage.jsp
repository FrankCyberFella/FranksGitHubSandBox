...
<html>
	...
	<body>
		<div id="main_content">
			...
			<p>Of course you do!  Everyone wants more <strong>awesomeness</strong> in their life!  Well, 
			guess what you lucky stiff?  Your desire for more awesomeness is about to be <strong>fulfilled</strong>!  Just do the following:</p>
			<ol>
