...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {  // contains code that might throw an exception
			...
			//  e is the name of the Exception object in this catch block.  FF uses 
			// Flow of control resumes here after the Exception is thrown
			System.out.println("XXX   Uh-oh, something went wrong...   XXX");
			// can do stuff with Exception objects, for example get info on exception 
			// System.out.println("invalid index was " e.getMessage());   // or e.getStackTrace()  etc.  
