...
// define a default constructor - will assign default values to the data of the class.  "we decide"
...
// ctpr fpr a card for only suit, value  ( we are allowing a default card
	...
	// make another ctor to create card with more parameter...suit, value, image, shape.
	...
	// to avoid duplicate code(like above)>>> create method to determine card color based on suit and plugged it into ctor above. 
//  restrict usage to members of class-- don't want class users to be able to run this--make it private.
...
private void determineColor(String suit) {
	...
	// method for displaying the values in a PlayingCard
	public void showCard() {
		System.out.println("Card suit: " + suit);
		System.out.println("Card suit: " + color);
		System.out.println("Card suit: " + value);
		System.out.println("Card suit: " + image);
		System.out.println("Card suit: " + shape);
	}
