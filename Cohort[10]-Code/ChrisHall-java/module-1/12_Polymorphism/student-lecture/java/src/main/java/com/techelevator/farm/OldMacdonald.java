...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		FarmAnimal anAnimal = new FarmAnimal("Sheep", "baa"); // *** super class may be used to define objects of
																// subclass
		FarmAnimal Bessie = new Cow();
		FarmAnimal FogHorn = new Chicken();

		/*
		 * FarmAnimal anAnimal = new FarmAnimal("Sheep", "baa"); Cow Bessie = new Cow();
