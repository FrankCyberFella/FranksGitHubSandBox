...
public class BuyoutAuction extends Auction {
	...
	public BuyoutAuction(String itemForSale, int buyoutPrice) {
		super(itemForSale); // the derived class MUST call a base class ctor to initialize the data from the base classq
	...
	public boolean placeBid(Bid offeredBid) {
		...
		if(getHighBid().getBidAmount() < buyoutPrice) {
			...
			isCurrentWinningBid = super.placeBid(offeredBid); // run the super class placeBid() method
		}
