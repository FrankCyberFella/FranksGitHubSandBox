...
public class Lecture {  //  collections part 1 lecture 
	...
	public static void main(String[] args) {
		...
		// double newBalance = accountBalance + 100;  // this causes a NullPointerException because we are 
		//trying to "unbox" a null value
