...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		int[] nums = new int[theNums.length];      // define an int array to hold the String array elements converted 
													//	to ints
				
		for (int i=0; i<theNums.length; i++) {     // Loop through String array one element at a time
			nums[i] = Integer.parseInt(theNums[i]);// Convert the current element in String array to an int and 
