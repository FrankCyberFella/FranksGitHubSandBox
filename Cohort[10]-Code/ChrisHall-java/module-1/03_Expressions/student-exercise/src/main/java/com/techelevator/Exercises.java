...
<<<<<<< HEAD
	...
	public boolean posNeg(int a, int b, boolean negative) {
		...
		// }
		// }
		boolean oneNegOnePos = (a < 0) ^ (b < 0);
		boolean bothNeg = (a < 0) && (b < 0);
		boolean bothPos = (a >= 0) && (b >= 0);

		if (oneNegOnePos && negative == true) {
			return false;
		} else {
			if (oneNegOnePos && negative == false) {
				return true;
			}
		}

		if (bothNeg && negative == true) {
			return true;
		} else if (bothNeg && negative == false) {
			return false;
		}

		if (bothPos && negative == true) {
			return false;
		} else if (bothPos && negative == false) {
			return false;
		}
=======
