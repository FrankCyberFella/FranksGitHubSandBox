...
-- 2. plug the result of subquery into the where clause
--
...
select name, lifeexpectancy
 ...
 select name, lifeexpectancy
  from country
where lifeexpectancy > (select avg(lifeexpectancy)  -- subquery - a select for a value used in a where clause
                          from country)  
