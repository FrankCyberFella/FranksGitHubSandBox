...
function stringFunctions(value) {
  ...
  function arrayFunction(){
    ...
    stooges.push("Shemp");  //adds to end

    console.table(stooges);

    stooges.unshift("Curly Joe"); //adds to beginning 
    console.table(stooges);

    stooges.splice(3,0,"Groucho","Chicho","Harpo"); //add an element starting at index 3
    console.table(stooges);

    stooges.splice(3,1); //add an element starting at index 3
    console.table(stooges);
