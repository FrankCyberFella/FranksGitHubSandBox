...
// save description and ignore it if they hit escape
...
function toggleDescriptionEdit(desc) {
  const textBox = desc.nextElementSibling;  //get a reference to input box
  textBox.value = description;              // remember current description
  textBox.classList.remove('d-none');       // un-hide input box
  desc.classList.add('d-none');             // hide the description

  textBox.focus();                          // give input box focus (i.e. pur cursor in)
}
