...
public class SignUp {
	...
	@NotBlank(message="Name is required")	//optional message
	private String name;
	
	@NotBlank(message="Email address is required")
	@Email(message="Email must be a valid email address")	//validate format of email NOT that it is real
	...
	private boolean emailMatching; // Dummy property to get matching validation working
								   // Isn't actually needed in our current version of spring
	@AssertTrue(message="Emails must match")
	public boolean isEmailMatching() {
		if(email != null) {
			return email.equals(verifyEmail);		//returns true or false
		} else {
			return false;
		}
	}
