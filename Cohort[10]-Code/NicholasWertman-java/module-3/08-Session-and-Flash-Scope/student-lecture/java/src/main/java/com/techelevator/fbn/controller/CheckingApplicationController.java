...
public class CheckingApplicationController {
	...
	public String processPersonalInformationInput(@RequestParam String firstName,
		...
		session.setAttribute("customerApplication", application);	//store app in session map with name customerApplication
	...
	public String displayAddressInput() {
		return "checkingApplication/addressInput";		//run the address input .jsp
	}
	...
	public String processAddressInput(@RequestParam String streetAddress,
		...
		//adding address info to CheckingAccountApplication that was populated with personal info
...
// Now we have an application with all of the info that it needs (Personal Info + Address Info)
