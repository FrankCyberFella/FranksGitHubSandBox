...
public class testPolyApp {
	...
	//	Worker aWorker    = new Worker("Werk", "Kerr");  // can not instantiate an abstract class
	...
	public static void showTest(Worker aWorker, int hoursWorked) {		
		...
		System.out.printf("5%s %5s working for %6d hours makes $%8.2f per week\n", 
		                 ...
		                 aWorker.calculateWeeklyPay(hoursWorked)); //replace the 4th placeholder in the model
