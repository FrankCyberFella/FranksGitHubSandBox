...
<<<<<<< HEAD
	...
	public boolean posNeg(int a, int b, boolean negative) {
		if ((negative == true) && (a < 0 && b < 0))
			...
			if ((negative != true) && ((a > 0 && b < 0) || (a < 0 && b > 0)))
				return true;
		}
		{
			return false;
...
<<<<<<< HEAD
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		// else {
		if ((isBirthday == false && speed >= 81) || (isBirthday == true && speed >= 86)) {
			return 2;
		}
		// }
=======
...
<<<<<<< HEAD
	...
	public String alarmClock(int day, boolean vacation) {
		if (vacation == false && day < 6 && day > 0)
			return "7:00";
		else {
			if ((vacation == true && day < 6 && day > 0) || (vacation == false && (day >= 6 || day <= 0)))
				return "10:00";
		}
...
<<<<<<< HEAD
	...
	public boolean inOrderEqual(int a, int b, int c, boolean equalOk) {
		if ((a < b && b < c) || (equalOk == true && (a <= b && b <= c)))
			return true;
=======
