...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		float pie = 3.1416F;  //use the datatype indicator to tell Java it's a float (datatype conversion)
		...
		*/
				...
				String fullName = "Nicholas William Wertman";
		/*
		...
		*/
				 System.out.println("4.4 divide by 2.2 is " + 4.4/2.2);
...
System.out.println("1,000,000,000 times 3 is " + 1000000000L * 3);
	...
	boolean doneWithExercises = false; 
		...
		*/
		double num = 1.0/0;  //if int --> exception| if double --> infinity
