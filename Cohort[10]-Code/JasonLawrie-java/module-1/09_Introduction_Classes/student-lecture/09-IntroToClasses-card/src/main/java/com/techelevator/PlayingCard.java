...
public class PlayingCard {
	...
	//These can be called attributes, properties, characteristics, "stuff about the class", "piece of data"
	private String suit;
	...
	//ALLOW A DEFAULT CARD
	//define the default constructor - assign default values to the data of the class
	public PlayingCard() {
		suit = "Joker";
		color = "red";
		value = 0;
	...
	//define ctor for a card for only a suit and a value
	public PlayingCard(String suit, int aValue) {
		this.suit = suit;//demonstration that the parameter can match the class property, if we clarify which one is which
		determineColor(suit);
		value = aValue;
		image = value + " " + suit;
		shape = "rectangle";
	...
	//define ctor for a card that inputs suit, value, image, shape
	public PlayingCard(String suit, int aValue, String image, String shape) {
		this.suit = suit;//demonstration that the parameter can match the class property, if we clarify which one is which
		determineColor(suit);
		value = aValue;
		this.image = image;
	...
	//another version of getValue (that returns a string?)
	...
	//method to display the values in PlayingCard
