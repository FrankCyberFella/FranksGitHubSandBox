...
public class introToClassesCard {
	...
	public static void main(String[] args) {
        ...
        */
		...
		PlayingCard card3 = new PlayingCard("Spades", 13, "King", "Octagon");
		...
		System.out.println("Image in card 3 is: " + card3.getImage());
		card3.setImage("Tinkerbell");
		System.out.println("Name of the value in card 3: " + card3.getValueName());
    }
