...
public class UserController {
	...
	public String submitRegisterForm(
			@Valid @ModelAttribute("SignUp") SignUp registerFormValues, //validate the data in model entry SignUpand put the data in a SignUp object called registerFormValues
