...
BEGIN TRANSACTION;
INSERT INTO countrylanguage (countrycode,language,isofficial,percentage) VALUES ('USA','Klingon',true,10);
SELECT * from countrylanguage WHERE countrycode = 'USA';
--ROLLBACK; --undo/reset since the last commit or rollback
--SELECT * from countrylanguage WHERE countrycode = 'USA';
COMMIT;

-- 2. Add Klingon as a spoken language in Great Britain
BEGIN TRANSACTION;
INSERT INTO countrylanguage (countrycode,language,isofficial,percentage) VALUES ('GBR','Klingon',true,10);
