...
public class Exercises {
	...
	public String makeTags(String tag, String word) {
		String startTag = "<" + tag + ">";
		String endTag = "</" + tag + ">";
		String taggedWord = startTag+word+endTag;
		return taggedWord;
	}
	...
	public String makeOutWord(String out, String word) {
		...
		String outWord = outStart + word + outEnd;
		return outWord;
	}
	...
	public String extraEnd(String str) {
		String stringEnd = str.substring(str.length() - 2);
		String stringEndOut = stringEnd + stringEnd + stringEnd;
		return stringEndOut;
	}
	...
	public String firstTwo(String str) {
		...
		if(str.length() < 2) {
			String firstTwoReturned = str;
			return firstTwoReturned;
		}

		String firstTwoReturned = str.substring(0, 2);
	...
	public String comboString(String a, String b) {
		...
		if (a.length() > b.length()) {
			String shortLongshort = b+a+b;
			return shortLongshort;
		}
		
		String shortLongshort = a+b+a;
		return shortLongshort;
	}
	...
	public String left2(String str) {
		...
		String left2Rotate = str.substring(2) + str.substring(0, 2);
		return left2Rotate;
	}
	...
	public String right2(String str) {
		...
		String right2Rotate = str.substring(str.length() - 2) + str.substring(0, str.length() - 2);
		return right2Rotate;
	...
	public String theEnd(String str, boolean front) {
		if (!front) {
			String theEnd = str.substring(str.length() - 1);
			return theEnd;
		}
		
		String theEnd = str.substring(0, 1);
		return theEnd;
	}
	...
	public boolean doubleX(String str) {
		...
		for (int i = 0; i < str.length() - 1; i++) {
			if (str.substring(elementCounter, elementCounter + 2).equals("xx")) {
				return true;
			}
		}
	...
	public int last2(String str) {
		...
		for (int i = 0; i < str.length() - 1; i++) {
			if (str.substring(i, i + 1).equals(str.substring(str.length() - 2, str.length() - 1)) && str.substring(i + 1, i + 2).equals(str.substring(str.length() - 1))) {
				subStringCount++;
			}
		}
