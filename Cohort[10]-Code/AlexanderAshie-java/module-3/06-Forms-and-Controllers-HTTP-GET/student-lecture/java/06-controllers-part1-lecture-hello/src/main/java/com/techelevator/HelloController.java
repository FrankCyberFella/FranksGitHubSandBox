...
public class HelloController {
	...
	public String displayGreeting(HttpServletRequest request) {
		...
		String name = request.getParameter("name"); //get the parameter and store in the string
		Greeter greeter = new Greeter(name); //construct a Greeter using the paramter
		request.setAttribute("greeting", greeter.getGreeting()); //add getGreeting string to value of request map
