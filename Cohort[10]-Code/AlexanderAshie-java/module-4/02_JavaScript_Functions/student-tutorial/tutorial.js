 ...
 */
 ...
 function takeOptionalParameter(item = 0) {
   return item;
 }
 ...
 */
 ...
 /**
  * returns the converted temperature, and if is given a true value in paramters, include the converted unit string C or F
  * @param {Number} temperature the number of temperature to be converted
  * @param {String} temperatureUnit takes in a T or F string, used to decide which conversion method to use
  * @param {Boolean} [includeUnit] = false, defaults to false without a given true
  */
