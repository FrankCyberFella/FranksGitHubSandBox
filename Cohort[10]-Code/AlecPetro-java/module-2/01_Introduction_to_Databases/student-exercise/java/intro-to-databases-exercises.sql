...
select name, gnp / population as per_capita_gnp from country where continent = 'Europe';
-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
select name, 2019 - indepyear as years_since_indep from country where indepyear is not null; 