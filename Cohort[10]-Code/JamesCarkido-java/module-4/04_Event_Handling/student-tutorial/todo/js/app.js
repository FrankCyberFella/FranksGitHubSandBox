...
document.addEventListener('DOMContentLoaded',() => {   // curious as to the syntax of this
  init();
  addPageTitle();
  addTodos();
  ...
  const tasks = document.querySelectorAll('li');  //  this gives us a nodeList of li's returned
