...
function allDivisibleByThree(numbersToFilter) {}
  return numbersToFilter.filter((element)=>{ // filter says kee[ the element if the function returns true]
    // return element % 3 === 0; //return true if number is divisible by 3
    return !(element % 3);   // all values have a true or false. 0 is false so we are using ! to say if 0 return true
    });                      // this is because of truthiness 
