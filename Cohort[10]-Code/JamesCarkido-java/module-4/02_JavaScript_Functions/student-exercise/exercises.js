 ...
 */
 ...
 /**
  * takes numerical value of month and day and string value of hemisphere 
  * and determines if it is Summer
  * 
  * @param {number} month value represents months in a year
  * @param {number} day value represents days in a month
  * @param {String} hemisphere must be 'northern' or 'southern'
  * @returns {boolean} true if summer false if not
  */
...
function getFullAddressesOfProperties(addressComponentArray){
  return addressComponentArray.map((element)=>{
