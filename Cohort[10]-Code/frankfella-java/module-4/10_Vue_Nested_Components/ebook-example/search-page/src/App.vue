...
<template>
  <div id="app">
    <search-box
      ...
      v-on:search-results="handleResults">   <!-- when search-results event happens call handleResults method -->
    </search-box>
...
export default {
  ...
  data() {
    return {
      searchResults: { "Results": [] } // searchResults is an array [] populated by the api call
    }
  },
  methods: {
