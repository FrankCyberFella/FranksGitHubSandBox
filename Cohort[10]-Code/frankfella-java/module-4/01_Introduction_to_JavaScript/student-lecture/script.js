...
function variables() {
  ...
  let daysPerMonth =30;
  console.log(`There are ${daysPerWeek} in month`);
...
function stringFunctions(value) {
  ...
  console.log(`.substring(value, 2,3) - ${value.substring(2,3)}`) // start-index, end-index (not included)
...
function arrayFunction() {
  ...
  stooges.splice(3,0,"Groucho", "Chico", "Harpo");  // add an elements starting at index 3 of array
  console.table(stooges);

  stooges.splice(3,1);  // remove one element starting at index 3
  console.table(stooges);

  stooges.splice(3,2);  // remove one element starting at index 3
  console.table(stooges);

  stooges.shift();  // remove one element at start
  console.table(stooges);
