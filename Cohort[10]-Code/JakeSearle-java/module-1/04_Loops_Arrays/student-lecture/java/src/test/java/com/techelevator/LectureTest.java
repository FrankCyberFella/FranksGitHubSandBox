...
public class LectureTest {
    ...
    Lecture exercises = new Lecture(); // gives us access to all data and methods in this class (Lecture)
    
    @Test
    public void testReturnArray() {             //object-with-code.method-to-test(any-params-for-method)
