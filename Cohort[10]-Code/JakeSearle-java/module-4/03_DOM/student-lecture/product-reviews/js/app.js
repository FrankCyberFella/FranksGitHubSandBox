...
function setPageTitle() {
  const pageTitle = document.getElementById('page-title'); // get me to the element where the id = page-title
  pageTitle.querySelector('.name').innerText = name;       // get me to the element with the class .name and 
}                                                          // set the text to whatever is in the name variable
