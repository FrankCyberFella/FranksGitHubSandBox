<template>
  <div id="app">
    ...
    <shopping-list title='Costco' v-bind:data='costco' v-bind:query='filter'></shopping-list>
    <shopping-list title='Groceries' v-bind:data='groceries' v-bind:query='filter'></shopping-list>
    <shopping-list title='Target' v-bind:data='target' v-bind:query='filter'></shopping-list>
  </div>
</template>
