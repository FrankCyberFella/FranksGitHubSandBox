 ...
 * 
 * @param {String[]} stringToHappy the string that the user wants to add 'Happy' to
 * @returns {String[]} an array that contains the old string with 'Happy' concatenated to the front
 */
function makeHappy(stringToHappy) {
return stringToHappy.map((element) => {
 ...
 * 
 * @param {number[] string []} array is the array to search
 * @returns {number or string} the number or string that is the largest
 */
