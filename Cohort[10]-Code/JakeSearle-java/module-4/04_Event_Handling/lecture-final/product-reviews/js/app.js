/***********************************************************************************
 * Event Handling - Lecture Final - Note: Lecture Code begins below 
 ***********************************************************************************/
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const btnToggleForm = document.getElementById('btnToggleForm'); // if user moves mouse outside box,
  btnToggleForm.addEventListener('click', () => {                 // treat it like an escape press
    showHideForm();
  });
  ...
  btnSaveReview.addEventListener('click', (event) => {
    event.preventDefault(); // this says dont perform default button action because we want to do our own thing instead
    saveReview();           // do this instead of the default
  });
});
...
function toggleDescriptionEdit(desc) {
  const textBox = desc.nextElementSibling; // get reference to input box
  textBox.value = description;             // Remember the current description
  textBox.classList.remove('d-none');      // Un-hide the input box
  desc.classList.add('d-none');            // hide the description
  textBox.focus();                         // give the input box focus (ie put cursor in it)
}
