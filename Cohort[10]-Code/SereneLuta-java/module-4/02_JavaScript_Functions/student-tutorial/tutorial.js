 ...
 */
 ...
 /**
  * @param {number} temperature current temp
  * @param {string} temperatureUnit 'C' for celsius 'F' for fahrenheit
  * @param {boolean} [includeUnit] = false 
  * @returns {number, boolean, string} returns the values for convertedTemp, includeUnit and convertedUnit
  */
