...
public class Exercises {
	...
	public String makeTags(String tag, String word) {
		...
		return leftCarot + tag + rightCarot + word + leftCarot + forwardSlash + tag + rightCarot;
	}
	...
	public String right2(String str) {
		String stringLastTwo = str.substring(str.length() - 2);
		String stringMain = str.substring(0, str.length() - 2);
		return stringLastTwo+ stringMain;
	}
	...
	public String theEnd(String str, boolean front) {
		String indexOne = str.charAt(0) + "";
		String indexLast = str.charAt(str.length() - 1) + "";
	...
	public String frontTimes(String str, int n) {
		String stringTimesThree = "";
		if(str.length() < 3) {
			for (int i = 0; i < n; i++) {
				stringTimesThree = stringTimesThree + str;
			}
		}
		else {
			if(str.length() >= 3) {
			for (int i = 0; i < n; i++) {
				stringTimesThree = stringTimesThree + str.substring(0,3);
			}
			}
		}
		return stringTimesThree;
	}
