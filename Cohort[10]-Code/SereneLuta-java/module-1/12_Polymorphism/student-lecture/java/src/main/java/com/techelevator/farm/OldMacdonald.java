...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		FarmAnimal anAnimal = new FarmAnimal ("Sheep", "baa"); // super class may be used to define objects of the subclass
		FarmAnimal Bessie = new Cow(); // calls the cow constructor
		FarmAnimal FogHorn = new Chicken(); //calls the chicken constructor
