...
<<<<<<< HEAD
		...
		int number = 0; // variable to hold keyboard input
		int number2 = 0;
		...
		System.out.println("Please enter another number: ");
		 ...
		 // get a line from keyboard and put it in variable aLine
		aLine = keyboard.nextLine();
		
		number = Integer.parseInt(aLine); // convert String to int
		number2 = Integer.parseInt(aLine);
