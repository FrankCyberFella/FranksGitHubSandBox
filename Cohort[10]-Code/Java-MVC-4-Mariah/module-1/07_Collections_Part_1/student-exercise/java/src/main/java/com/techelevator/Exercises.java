...
//		int smallerLength = listOne.size();   // hold the number of items in teh smaller list
//
...
//      interleave into listCombo the same number of elements - size are equal
		...
		for (i = 0; i < smallerLength; i++) {   // loop for the # of items of listOne
			listCombo.add(listOne.get(i));          // get an item from listOne and add it to listCombo
			listCombo.add(listTwo.get(i));          // get an item from listTwo and add it to listCombo
		}		
		
// handle what if one is smaller than the other - add the remaining items in the longer to listCombo
