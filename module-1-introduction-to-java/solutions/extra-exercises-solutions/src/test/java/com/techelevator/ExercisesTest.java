...
public class ExercisesTest {
    ...
    */
    ...
    public void arraySort() {
		...
		assertArrayEquals("Input: {})", new int[]{}, exercises.arraySort(new int[]{}));
		assertArrayEquals("Input: {100})", new int[]{100}, exercises.arraySort(new int[]{100}));
		assertArrayEquals("Input: {5, -3, 15})", new int[]{-3, 5, 15}, exercises.arraySort(new int[]{5, -3, 15}));
    }
    ...
    */
    ...
    public void findPermutations() {
		List<String> trialList = exercises.findPermutations(null);
		assertEquals(0, trialList.size());

		trialList = exercises.findPermutations("");
		assertEquals(0, trialList.size());

		trialList = exercises.findPermutations("A");
