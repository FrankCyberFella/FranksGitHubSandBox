...
<<<<<<< HEAD
import java.util.Scanner; // This says include the Java code to support Scanner
=======
...
<<<<<<< HEAD
		Scanner keyBoard = new Scanner(System.in); // We are defining the Scanner object to access keyboard
		...
		aLine = keyBoard.nextLine(); // get a line from keyboard and put it in  varaible aLine
		...
		aLine = keyBoard.nextLine(); // get a line from keyboard and put it in  varaible aLine
		pctg = Double.parseDouble(aLine);  // convert a string to a double
=======
