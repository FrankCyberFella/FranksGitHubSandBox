...
// add toString() - to convert a PlayingCard to a String
...
// Annotation is a direction to the compiler - Always starts with the @ sign
public String toString() {
		return value + " " + suit + " " + color + " " + faceUp;
	}

// .equals() - compare two PlayingCards
// No @Override is necessary because the superclass does not have a .equals() that taks a PayingCard as a parameter
