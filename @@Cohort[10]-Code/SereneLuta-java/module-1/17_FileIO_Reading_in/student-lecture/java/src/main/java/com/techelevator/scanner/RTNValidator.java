...
public class RTNValidator {
	...
	@SuppressWarnings("resource") // Methods returns a File object for a file that exists
	private static File getInputFileFromUser() { // this will return a File object
		...
		File inputFile = new File(path); // Defines a File object to represent the file
