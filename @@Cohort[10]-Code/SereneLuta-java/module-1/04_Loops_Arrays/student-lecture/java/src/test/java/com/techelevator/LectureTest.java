...
public class LectureTest {
    ...
    Lecture exercises = new Lecture(); // Must instantiate an object of the class containing the code you want to test. Gives us access to all the data and methods in a this class
    
    @Test
    public void testReturnArray() { // object-with-code.method-to-test(any-parameters-for-the-method
        assertArrayEquals(new int[] {80,8080,443}, exercises.returnArray()); // you use the object name "exercises" and use it to return your test result
    ...
    }				//message-if-the-test-fails					 , expected result, method-you-are-testing
