...
public class BuyoutAuction extends Auction {
	...
	public BuyoutAuction(String itemForSale, int buyoutPrice) {
		super(itemForSale); // derived class MUST call a base class constructor to initialize the data from the base class
...
BigDecimal newBalance = balance + amountToDeposit;
