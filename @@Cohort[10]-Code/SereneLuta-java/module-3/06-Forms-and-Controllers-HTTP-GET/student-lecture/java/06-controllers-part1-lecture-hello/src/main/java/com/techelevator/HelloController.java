...
public class HelloController {
	...
	public String displayHomePage() {
		...
		return "homePage"; //logical view name - jsp
	}
	...
	public String displayGreeting(HttpServletRequest request) {
		...
		String name = request.getParameter("name"); //get value on the form: name=dataAssigned
		Greeter greeter = new Greeter(name);		//Instantiate a Greeter object using the value from the query string
		request.setAttribute("greeting", greeter.getGreeting()); //Add the value from getGreeting as an entry in the request map
																// with the key "greeting"
