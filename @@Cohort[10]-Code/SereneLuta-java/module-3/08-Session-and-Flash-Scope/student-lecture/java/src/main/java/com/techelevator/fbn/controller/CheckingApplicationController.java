...
public class CheckingApplicationController {
	...
	public String displayPersonalInformationInput() {
		return "checkingApplication/personalInformationInput"; //returns a jsp (logical view)
	}
	...
	public String processPersonalInformationInput(@RequestParam String firstName,
		...
		return "redirect:/checkingApplication/addressInput"; //URL -> controller
						//directory			 //jsp file		 //redirect generates a GET request
	}
	...
	public String processAddressInput(@RequestParam String streetAddress,
		...
		CheckingAccountApplication application = (CheckingAccountApplication)session.getAttribute("customerApplication");
												  //cast it as a CheckingAccountApplication
		...
		//Now we have an application with all the information it needs (Personal & Address)
	...
	public String processApplication(HttpSession session) {
		...
		CheckingAccountApplication application = (CheckingAccountApplication)session.getAttribute("customerApplication");
		//Create CheckingAccountApplication application - cast as the Object with session.getAttribute("setAttributeKey")
