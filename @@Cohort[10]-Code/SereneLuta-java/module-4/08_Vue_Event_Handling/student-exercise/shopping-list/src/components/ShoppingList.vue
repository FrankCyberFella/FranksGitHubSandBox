<template>
    <div class="shopping-list">
        ...
        <ul>
            <li v-for="item in groceries" @click="changeStatus()" v-bind:key="item.id" v-bind:class="{completed: item.completed}">
    ...
    data() {
     ...
     methods: {
        changeStatus(id,$event) {
            const arrayIndex = this.groceries.findIndex((item) => item.id == id);
