...
public class KataStringCalculatorTest {
	...
	assertEquals("String did not return int 0 when empty", 0, KataStringCalculator.addString(""));
	}
	@Test
	...
	public void method_takes_three_numbers() {
		...
		assertEquals("String did not return sum of 100", 100, KataStringCalculator.addString("50,26,24"));
	}
	@Test
