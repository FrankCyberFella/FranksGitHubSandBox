...
public class LectureTest {
    ...
    Lecture exercises = new Lecture(); // instantiate object of the code we're testing, gives us access to all data and methods in Lecture class
    
    @Test
    public void testReturnArray() {				   //ObjectWithCode.methodToTest(anyParamsForMethod);
        assertArrayEquals(new int[] {80,8080,443}, exercises.returnArray());
    }	//				   expected result        method you're testing
    						// unless  exercises returns that exact integer array, it will fail
    @Test
    ...
    }					//message if test fails					expected result			method
