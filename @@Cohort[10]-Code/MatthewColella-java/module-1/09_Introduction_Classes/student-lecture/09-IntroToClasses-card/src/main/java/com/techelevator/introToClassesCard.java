...
<<<<<<< HEAD
		//aCard.showCard(); // run showCard using PlayingCard object
		
		PlayingCard card2 = new PlayingCard("Clubs", 5);
		//card2.showCard();
		
		PlayingCard card3 = new PlayingCard("Clubs", 10, "Platypus", "Spherical");
		//card3.showCard();
		
		System.out.println("Color in Card 2 is: " + card2.getColor());
		System.out.println();
		System.out.println("Image on Card 3 is a: " + card3.getImage());
		System.out.println("Value on Card 3 is: " + card3.getValueName());
