...
// Annotation is a direction to the compiler, all start with @
@Override // Annotation - tells compiler make sure I am overriding an existing method
public String toString() { // convert the card to a string
	return value + " of " + suit + ", " + color + ", " + faceUp;
}
...
public void showCard() {
	...
	System.out.println("     Card value: " + valueString);
