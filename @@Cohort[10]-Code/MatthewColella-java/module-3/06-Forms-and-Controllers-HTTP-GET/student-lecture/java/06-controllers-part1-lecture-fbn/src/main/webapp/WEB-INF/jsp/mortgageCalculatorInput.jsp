...
<form method="GET" action="${formAction}">						<!-- On submit run mortgageCalculatorResult.jsp-->
	<div class="formInputGroup">
		<label for="loanAmount">Loan Amount:</label> 
		<input type="text" name="loanAmount" id="loanAmount" /><!-- this name holds the variable  -->
	</div>
	<div class="formInputGroup">
