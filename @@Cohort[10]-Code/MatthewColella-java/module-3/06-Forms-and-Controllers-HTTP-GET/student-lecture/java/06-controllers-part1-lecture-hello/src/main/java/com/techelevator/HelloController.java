...
public class HelloController {
	...
	public String displayHomePage() {
		...
		return "homePage"; //jsp file(logical view name)
	}
	...
	public String displayGreeting(HttpServletRequest request) {
		...
		String name = request.getParameter("name");				//get value from name= in URL
		Greeter greeter = new Greeter(name);					//instantiate a Greeter object using value
