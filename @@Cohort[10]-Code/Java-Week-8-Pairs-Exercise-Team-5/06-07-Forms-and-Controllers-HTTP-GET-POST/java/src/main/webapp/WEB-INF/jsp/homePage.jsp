...
<div id="inner-planets" class="planets">
    <h1>Inner Planets</h1>
    <section class="planet">
    <div class="Mercury">
        <h2>Mercury</h2>
        <c:url var="mercuryImgSrc" value="/img/mercury.jpg" />
		<img id="Mercury" src="${mercuryImgSrc}" alt="Mercury">
    ...
    <div class="Venus">
		...
		<img id="Venus" src="${venusImgSrc}" alt="Venus">
    ...
    <div class="Mars">
		...
		<img id="Mars" src="${marsImgSrc}" alt="Mars">
...
<div id="outer-planets" class="planets">
    <h1>Outer Planets</h1>
    <section class="planet">
    <div class="Jupiter">
        <h2>Jupiter</h2>
        <c:url var="jupiterImgSrc" value="/img/jupiter.jpg" />
		<img id="Jupiter" src="${jupiterImgSrc}" alt="Jupiter">
    ...
    <div class="Saturn">
		...
		<img id="Saturn" src="${saturnImgSrc}" alt="Saturn">
   ...
   <div class="Uranus">
		...
		<img id="Uranus" src="${uranusImgSrc}" alt="Uranus">
    ...
    <div class="Neptune">
		...
		<img id="Neptune" src="${neptuneImgSrc}" alt="Neptune">
