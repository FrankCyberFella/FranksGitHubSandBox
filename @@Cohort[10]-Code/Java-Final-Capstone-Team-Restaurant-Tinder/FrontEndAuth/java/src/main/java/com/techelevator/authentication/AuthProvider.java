...
public interface AuthProvider {
     ...
     */
    void register(String username, String password, String role, String city, String state, String current_preference);
    //void saveRestaurant(String name, String cuisine, int price, double rating, String address, String locality, int city, String menu);
