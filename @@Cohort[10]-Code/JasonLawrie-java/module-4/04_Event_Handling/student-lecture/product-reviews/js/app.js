...
function changeDescription(theEle){
  //unhide the input box
  const textInput=theEle.nextElementSibling;
  textInput.classList.remove('d-none');
  theEle.classList.add('d-none');
  //get the data from the input box
  
  //set the description element innerText
  textInput.addEventListener('blur',()=>{
    theEle.innerText=textInput.value;
    textInput.classList.add('d-none');
    theEle.classList.remove('d-none');
...
reviewDesc.addEventListener('click',(e)=>{
