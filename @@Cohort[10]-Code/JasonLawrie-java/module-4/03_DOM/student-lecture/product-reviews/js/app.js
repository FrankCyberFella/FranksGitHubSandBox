...
function displayReviews() {
  ...
  reviews.forEach(review=>{
    const thisReview=document.createElement('div');
    thisReview.setAttribute('class','review');
    const paraElement=document.createElement('p');
    paraElement.innerText=review.review;
    mainBody.appendChild(thisReview);
    thisReview.appendChild(paraElement);
  })
}
