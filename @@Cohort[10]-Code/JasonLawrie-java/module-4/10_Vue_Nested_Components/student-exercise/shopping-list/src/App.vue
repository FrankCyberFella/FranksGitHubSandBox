<template>
  <div id="app">
    ...
    <shopping-search v-on:search="changeTerm"></shopping-search>
    <shopping-list title="GROCERY STORE" v-bind:data="groceries" v-bind:term="searchTerm"></shopping-list>
    <shopping-list title="COSTCO" v-bind:data="costco" v-bind:term="searchTerm"></shopping-list>
    <shopping-list title="TARGET" v-bind:data="target" v-bind:term="searchTerm"></shopping-list>
  </div>
</template>
