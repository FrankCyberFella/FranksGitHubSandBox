...
public String toString() {
	return faceUp ? getValueName() + " of " + suit + " is face up" : getValueName() + " of " + suit + " is face down";
}

//equals() - to compare two playincards -- this has a different argument than the object class equals method

public boolean equals(PlayingCard card2) {
