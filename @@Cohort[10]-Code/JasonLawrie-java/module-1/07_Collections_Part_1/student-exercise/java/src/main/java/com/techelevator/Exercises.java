...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		...
		for(String givenElement : stringArray) {
			myList.add(givenElement);
		}
		return myList;
	}
	...
	public List<String> reverseList(List<String> stringList) {
		...
		List<String> myList = new ArrayList<String>();
		for(String givenToReverse : stringList) {
			myStack.push(givenToReverse);
		}
	...
	public List<Integer> oddOnly(Integer[] integerArray) {
		List<Integer> oddIntList = new ArrayList<Integer>();
	...
	public boolean foundIntTwice(List<Integer> integerList, int intToFind) {
		//return integerList.indexOf(intToFind)!=-1&&integerList.indexOf(intToFind)!=integerList.lastIndexOf(intToFind);
		//This works but I don't want to be TOO aggressively one-liner
		int foundCounter = 0;
    ...
    ** INTERVIEW QUESTION **	 
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		List<String> myFizzBuzz = new ArrayList<String>();
		for(int i:integerArray) {
			if(i%3==0&&i%5==0) {
				myFizzBuzz.add("FizzBuzz");
			} else if(i%3==0) {
				myFizzBuzz.add("Fizz");
			} else if(i%5==0) {
				myFizzBuzz.add("Buzz");
			} else {
				myFizzBuzz.add(Integer.toString(i));
			}
		}
		return myFizzBuzz;
	}
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		List<Integer> myWeave = new ArrayList<Integer>();
			for(int i = 0; i<Math.max(listOne.size(), listTwo.size());i++) {
				if(listOne.size()>i) {
					myWeave.add(listOne.get(i));
				}
				if(listTwo.size()>i) {
					myWeave.add(listTwo.get(i));
				}
			}
		return myWeave;
	}
	...
	public List<Integer> boardingGate(List<Integer> seatNumberList) {
		List<Integer> myLastList = new ArrayList<Integer>();
