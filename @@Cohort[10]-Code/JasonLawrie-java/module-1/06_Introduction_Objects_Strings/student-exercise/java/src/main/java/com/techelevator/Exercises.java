...
public class Exercises {
	...
	public String extraEnd(String str) {
		String lastString="";
		for(int i=0;i<3;i++) {
			lastString+=str.substring(str.length()-2);
		}
		return lastString;
	}
	...
	public String comboString(String a, String b) {
		...
		if(a.length()<b.length()) {
			sandwichString=a+b+a;
		} else {
			sandwichString=b+a+b;
		}
	...
	public String left2(String str) {
		...
		rotatedString=str.substring(2,str.length())+str.substring(0,2);
	...
	public String theEnd(String str, boolean front) {
		...
		if(front) {
			desiredLetter=str.substring(0,1);
		} else {
			desiredLetter=str.substring(str.length()-1,str.length());
		}
	...
	public String twoChar(String str, int index) {
		String twoPieceStr=str.substring(0,2);
		if(index<str.length()-1&&index>0) {
			twoPieceStr=str.substring(index,index+2);
		}
		return twoPieceStr;
	}
	...
	public String stringSplosion(String str) {
		...
		for (int i=1;i<=str.length();i++) {
			explodedString+=str.substring(0,i);
		}
	...
	public String stringX(String str) {
		...
		if(str.length()>1) {
			...
			//String[] piecesOfString = str.substring(1,str.length()-1).split("x");
			//stitchedString=str.substring(0,1)+String.join("", piecesOfString)+str.substring(str.length()-1,str.length());
			
			
			stitchedString=str.substring(0,1)+str.substring(1,str.length()-1).replaceAll("x", "")+str.substring(str.length()-1,str.length());
	...
	public String stringYak(String str) {
		//if(str.indexOf("y")!=-1) {
		//	if(str.substring(str.indexOf("y")+2).equals("k")) {
		//		I just realized I can use regex 
		//	}
		//}
		//String[] splitWithRegEx=str.split("y\\Sk");
		//return String.join("", splitWithRegEx);
		
		//But wait! I can do this even shorter!
		return str.replaceAll("y\\Sk", "");
	}
