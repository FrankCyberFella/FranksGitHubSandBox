<!-------------------------------------------------------------->
<!-- Vue Nested Components - ProductReview.vue - Lecture Final-->
<!-------------------------------------------------------------->
<template>
  <div class="main">
...
export default {
  ...
  computed: {
    averageRating(vm) {
      // Write the following line during lecture to fix found bug.
