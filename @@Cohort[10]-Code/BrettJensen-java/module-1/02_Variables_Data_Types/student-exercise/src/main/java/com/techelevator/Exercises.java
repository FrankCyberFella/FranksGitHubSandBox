...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
		...
		int remainingNumberOfRaccoons = initialNumberOfRaccoons - raccoonsThatLeft;
        ...
        */
		...
		double dime = 0.10;
		double nickel = 0.05;
		double mrsHiltMoney = quarter + dime + (nickel * 2);
		System.out.println(mrsHiltMoney);
        ...
        */
		...
		int snowAtMrsHilt = 29;
		int snowAtBrecknock = 17;
		int moreSnowAtMrsHilt = snowAtMrsHilt - snowAtBrecknock;
		System.out.println(moreSnowAtMrsHilt);
        ...
        */
		...
		int toyTruck = 3;
		int pencil = 2;
		int moneyLeft = startMoney - toyTruck - pencil;
        ...
        */
		...
		int moreShellsNeeds = 25 - currentSeashells;
        ...
        */
		...
		int legsPerBee = 6;
		int bees = 8;
		int totalBeeLegs = bees * legsPerBee;
        ...
        */
		...
		int numberOfCones = 2;
		double totalCostOfIceCream = costOfIceCreamCone * numberOfCones;
        ...
        */
		...
		int moreRocksNeeded = totalRocksNeeded - currentNumberOfRocks;
        ...
        */
		...
		int amountOfMarbles = 38;
		int marblesHiltLost = 15;
		int marblesHiltHasLeft = amountOfMarbles - marblesHiltLost;
        ...
        */
		...
		double pencilsToBuy = hiltsMoney / costOfPencil;
        ...
        */
		...
		double changeDue = moneyKatePaid - costOfCandy;
        ...
        */
		...
		int marksTrees = 13;
		int treesToPlant = 12;
		int totalTrees = marksTrees + treesToPlant;
        ...
        */
		...
		int kimsCousins = 4;
		int gumPerPerson = 5;
		int totalGumNeeded = kimsCousins * gumPerPerson;
        ...
        */
		...
		double moneyLeftForDan = dansMoney - candyCost;
        ...
        */
		...
		int cookiesPerJar = 6;
		int cookiesLeft = gingerbreadCookies % cookiesPerJar;
        ...
        */
		...
		int servingsAvailable = numberOfPretzels / pretzelServing;
		System.out.println(servingsAvailable);
        ...
        */
		...
		int lemonCupcakesTaken = lemonCupcakes - 2;
		int boxes = lemonCupcakesTaken / 3;
        ...
        */
		...
		int teddyBears = 98;
		int bearsPerShelf = 7;
		int shelvesUsed = teddyBears / bearsPerShelf;
        ...
        */
		...
		int picsPerAlbum = 20;
		int totalAlbums = familyPictures / picsPerAlbum;
        ...
        */
		...
		int cardsLeft = tradingCards % cardsPerBox;
		System.out.println(boxesFilled + " " + cardsLeft);
        ...
        */
		...
		int guests = 7;
		int croissantsEach = croissantsBaked / guests;
		System.out.println(croissantsEach);
