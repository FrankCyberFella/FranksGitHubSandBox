 ...
 */
		...
		System.out.println("------------------------------------------------");	
		System.out.println("  aNum.setScale(2,RoundingMode.DOWN is: " + aNum.setScale(2,RoundingMode.DOWN));
		System.out.println("  aNum.setScale(2,RoundingMode.UP   is: " + aNum.setScale(2,RoundingMode.UP));
