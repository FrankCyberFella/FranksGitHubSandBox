...
SELECT * FROM country; -- Select all the columns from this table
...
SELECT name FROM city where population > 400000 and district = 'Ohio';
...
SELECT population, lifeexpectancy, population/surfacearea as popperarea FROM country;

-- show countries whose population is between 1 and 2 mill
...
SELECT name FROM city WHERE district BETWEEN 'Ohio' and 'Utah' and countrycode = 'USA';
