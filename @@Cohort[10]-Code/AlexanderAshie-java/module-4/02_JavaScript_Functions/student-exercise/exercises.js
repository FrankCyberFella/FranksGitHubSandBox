 ...
 */
 ...
 /**
  * 
  * @param {Number} month the integer representation of a month
  * @param {Number} day the integer representation of the day defaults to 1 with no values given
  * @param {String} hemisphere the hemisphere of the earth, default value is northern is none is given
  * @returns which hemisphere it is summer in
  */
...
function addAll(...number) {
  return number.reduce((sum, element) => {
    return sum + element;
  });
}
