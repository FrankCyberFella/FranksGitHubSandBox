...
public class ProductController {
	...
	@RequestMapping("/") //url path this code handles
	public String showRoot(HttpServletRequest request) {  //receive request from the server
		request.setAttribute("productList", getProducts());  //create entry in request with getproducts
		return "productList";  //run the productList.jsp
	}  //return the name of the .jsp file to run

	@RequestMapping("/detailview")
	public String showDetailView(HttpServletRequest request) {
