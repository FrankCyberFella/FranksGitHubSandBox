...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//String values get enclosed in " ", you can add or concatenate values to a string using +
		...
		*/
		...
		String myFullName = "Alexander Thomas Ashie";
		...
		*/
		...
		String someName = "Hello, " + myFullName;
		...
		*/
		...
		/*
		27. What happens when you divide by 0?
		
		IF integer, exception thrown, if double, you get infinity
