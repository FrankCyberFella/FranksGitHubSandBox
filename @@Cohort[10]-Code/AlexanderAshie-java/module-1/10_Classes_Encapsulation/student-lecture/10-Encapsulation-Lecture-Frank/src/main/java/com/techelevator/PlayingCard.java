 ...
 * @return the faceUp
 */
public boolean isFaceUp() { //get method for booleans are "isName"
	return faceUp;
}
...
//Method to convert a playing card to a String
public String toString() {
	return value + " | " + suit + " | "+ color + " | " + faceUp;
}

//Define equals method to compare two playing cards
