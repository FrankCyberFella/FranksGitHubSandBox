...
public class introToClassesCard {
	...
	public static void main(String[] args) {
        ...
        */
		...
		PlayingCard aCard = new PlayingCard(); // instantiate a defulat playing card
...
<<<<<<< HEAD
		PlayingCard card3 = new PlayingCard("Clubs", 8, "8-ball", "circular"); // instantiate a round of clubs with an 8-ball
		card3.showCard();
...
>>>>>>> fa9d93e0ea31406930c4915172a3e8ebbec35daf
		...
		System.out.println("image in card3 is: " + card3.getImage());
<<<<<<< HEAD
		System.out.println("name in card3 is: " + card3.getImage());
		System.out.println("image in card3 is: " + card3.getImage());
		System.out.println("image in card3 is: " + card3.getImage());
    }
    }
