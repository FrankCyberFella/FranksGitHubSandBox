...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try { // contains code that might thrownan exception
		...
		} catch(ArrayIndexOutOfBoundsException e) { // catch an exception if one is thrown in try block
													// "e" is the name for the Excepton ofbject in this caatch block 
			// Flow of control resumes here after the Exception is thrown
			System.out.println("XXX   Uh-oh, something went wrong...   XXX");
			System.out.println("invalid index was:"+ e.getMessage()); // gets messade 
