...
public class testPolyApp {
	...
	public static void main(String[] args) {
		...
		Worker aWorker    = new Worker("Werk", "Kerr");// cannot instanitiate an abstract class
	...
	public static void showTest(Worker aWorker, int hoursWorked) {		
		...
		System.out.printf("%-5s %-10s working for %5d hours makes $%8.2f per week\n", 
		                 aWorker.getFirstName(),//replace the 1st placeholder in the model.
		                 aWorker.getLastName(), // replace the 2nd placeholder in the molel.
		                 hoursWorked,			// replace the 3rd placeholder in the molel.
		                 aWorker.calculateWeeklyPay(hoursWorked)); // replace the 4th placeholder in the molel.
