...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		//to loop through all the entries in a map, 1. put a keySet into a Set object
		//2. use a for-each to go through the Set object  - use the datatype of the key as your variable
		//3. inside loop use current for-each variable to .get() from Map
