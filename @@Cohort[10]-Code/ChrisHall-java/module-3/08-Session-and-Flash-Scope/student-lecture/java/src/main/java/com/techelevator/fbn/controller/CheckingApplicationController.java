...
public class CheckingApplicationController {
	...
	public String processPersonalInformationInput(@RequestParam String firstName,
												 ...
												 HttpSession session) {  // note session object parameter here and line 42 
		...
		session.setAttribute("customerApplication", application);  //  **** save the application object in session object
