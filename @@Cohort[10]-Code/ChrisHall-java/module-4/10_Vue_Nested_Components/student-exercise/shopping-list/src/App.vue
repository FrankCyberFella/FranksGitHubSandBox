<template>
  <div id="app">
    ...
    <shopping-search v-on:filter-items="handleSearch"></shopping-search>
    <shopping-list title="Grocery Store" v-bind:data="groceries" v-bind:search="search"></shopping-list>
...
body {
  ...
  background: radial-gradient(
    circle, rgba(61,201,164,1) 50%, rgba(92,133,120,1) 100%);
}
#app {
  display: grid;
