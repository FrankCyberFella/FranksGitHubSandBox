...
// an Annotation is a direction to the compiler.
@Override   // this is an annotation that tells compiler make sure I am overriding an existing method.

// we are deciding what a PlayingCard as a String looks like.
// toString()  convert a PlayingCard to a String:

/* public String toString(boolean wantFaceUp) {
	if (wantFaceUp) {
		return value + suit + color;
	}
	
	return value + suit + color + faceUp;
}
*/
...
// equals()  -- compare two PlayingCards.  Make our own because the superclass equals() method is different
//  does not take argument.  This is not an override.

public boolean equals(PlayingCard otherCard) {
	if (this.value == otherCard.value  // covers value
			
			&& this.suit.equals(otherCard.suit)) {  // this just covers suit
