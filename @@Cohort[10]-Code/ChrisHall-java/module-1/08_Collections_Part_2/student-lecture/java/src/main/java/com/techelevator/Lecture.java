...
public class Lecture {       ////   Collections part 2 lecture
	...
	public static void main(String[] args) {
		...
		//Map<String, String> nameToZip = new HashMap<String, String>();  // Map is an interface and HashMap is 
		// a class that implements Map
		
		Map<String, String> nameToZip = new TreeMap<String, String>(); 
		...
		nameToZip.put("David", "12345");  // The key "David" already exists, so this line will overwrite 
