...
public class Lecture {
	 ...
	 */
	public int returnFirstElement() { // note: int return type. Here we want to return a single value,
		// so we use int return value.
	...
	/*
	 * 6. Here, a variable is defined within a block. How can we get the value of
	 * that outside of the block in order to return it? There are a couple of
	 * different ways of doing this, what can you come up with?
	 */
	...
	public int returnVariableFromBlock(int number) {
		...
		return result; // We want to return result here. How? Two ways. One: Declare result above the
						// block
		// Two: put the return inside the block.
	}

	/*
	 * 7. What will the variable result be at the end of the method? Change the
	 * number in the logic expression so that it returns true.
	 */
	...
	/*
	 * 9. How many times do we go through this loop? Change the number in the logic
	 * expression so that it returns true.
	 */
	...
	/*
	 * 10. This loop is counting incorrectly. What needs to change in the loop for
	 * it to count properly?
	 */
	...
	/*
	 * 11. This loop is counting incorrectly. What needs to change in the loop for
	 * it to count properly?
	 */
	...
	/*
	 * 12. We want this loop to only count every other item starting at zero. What
	 * needs to change in the loop for it to do that?
	 */
