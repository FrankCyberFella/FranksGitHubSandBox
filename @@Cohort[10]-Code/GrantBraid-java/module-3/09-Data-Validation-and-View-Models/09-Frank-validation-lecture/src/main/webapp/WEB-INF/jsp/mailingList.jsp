...
<c:url value="/mailingList" var="mailingListSignUpUrl" />
			<!-- Use this URL on submit -->  	<!-- Issue a POST on submit -->		<!-- Use this model automatically with form -->
<form:form 	action="${mailingListSignUpUrl}" 	method="POST" 						modelAttribute="SignUp">
		<!-- form:errors path="*" cssClass="error"/ -->
        <div>
        	<label for="name">Name</label>
        	<form:input  path="name"  class="form-control"/>	<!-- name= identify the variable in the model backing the form -->
        ...
        <div>
            <input type="submit" value="Sign Me Up!"/> <!-- all variables are placed in response body -->
        </div>
</form:form>
</section>
