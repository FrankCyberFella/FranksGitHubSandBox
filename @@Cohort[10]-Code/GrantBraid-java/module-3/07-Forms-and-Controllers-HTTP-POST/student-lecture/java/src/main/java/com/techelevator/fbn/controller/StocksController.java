...
@Controller
@RequestMapping("/fbn")
@SessionAttributes("stocks") //This data item should persis across sessions - instead deleting at end of request
public class StocksController {
	...
	public String showStocksPage(ModelMap map){
		...
		map.put("stocks", stocks);				// add List called stock to ModelMap called map
