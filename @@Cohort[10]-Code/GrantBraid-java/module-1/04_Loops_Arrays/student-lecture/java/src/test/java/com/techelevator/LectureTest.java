...
public class LectureTest {
    ...
    @Test
    public void testReturnArray() { 		      // object-with-code.method-to-test(any-params-for-the-method)
    ...
    public void testReturnFirstElement() {
        ...
        //			  message-if-test-fails					  , expecetd, method-to-test
    }
