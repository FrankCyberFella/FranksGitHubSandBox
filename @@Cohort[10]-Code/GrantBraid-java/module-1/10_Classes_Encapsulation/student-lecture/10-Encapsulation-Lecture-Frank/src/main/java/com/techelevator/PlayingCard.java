...
// Annotation is a direction to the compiler - Start with @
@Override // Annotation - tells compiler make sure I am overriding an existing method
...
// No @Override is necessary because the supercase does not have a equals that takes a PlayingCard as a parameter
// equals() - compare two PlayingCards

public boolean equals(PlayingCard otherCard) { // override the object method with this classes method equals()
	if (this.value == otherCard.value && this.suit.equals(otherCard.suit)) { // use .equals to compare Strings
		return true;
	}
