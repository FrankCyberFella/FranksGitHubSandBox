...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// add/concatenate values to a string useing +
		...
		*/
		String name = "TechElevator"; // String is not a primitive data type
		...
		*/
		System.out.println("1,000,000,000 time 3 is " + 1000000000L * 3);
		/*
