...
import java.text.DecimalFormat;   // Includes the necessary code to use teh DecimalFormat class
...
public class RoundingExample 
{
    ...
    */
     ...
     *     %nd  - numeric integer with n-digits - %3d - indictates a 3-digit integer
   ...
   */
    ...
    System.out.println(myFormat.format(moneyFound));
   
    System.out.println("-------------------------------------------------------");  

    System.out.println("moneyFound after DecimalFormat: " + moneyFound);
