...
export default {
  ...
  methods: {
    increase() {
      this.counter += 1; // this component's counter will be incremented
    },
    decrease() {
      this.counter -= 1; // this component's counter will be decremented
    }
  }
};
</script>
...
export default {
  ...
  methods: {
    updateCounter(event) {
      this.counter += event.target.id === "increase" ? 1 : -1; // the id of the element clickedis checked
                                                               // if "increases" button swas clicked use 1 otherwise -1
    }
  }
};
</script>
