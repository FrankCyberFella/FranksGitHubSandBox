<template>
    <div class="todo-list">
        ...
        <ul>
            <li v-for="todo in todos" v-bind:key="todo.id" v-bind:class="{'todo-completed': todo.completed}"><input type="checkbox" v-on:click="changeStatus(todo.id)"/>
...
export default {
    ...
    methods: {
        changeStatus(id) {
            ...
            this.todos[id-1].completed  = !this.todos[arrIndex].completed;
        }
    }
