...
<!-------------------------------------------------------------->
<template>
    <form v-on:submit.prevent="performSearch"> <!-- on submit don't do default action, run performSearch -->
...
export default {
    ...
    methods: {
        ...
        performSearch() {
            ...
            // .then - wait for the response from the api and then return the json data
