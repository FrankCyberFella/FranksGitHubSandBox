...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("number of exercises is " + numberOfExercises);
...
String myFavoriteLanguage = "Java";
		...
		*/
double pi = 3.1416;  //decimals default to double
...
float pie = 3.1416F; // use the datatype indicator to tell java it's a float
		...
		*/
		String adamSouthwood = "Adam Southwood";
		/*
		...
		*/
		String fullName = "Adam Southwood";
		/*
		...
		*/
		String movieName = "Saw" + 2; // could do: + "2" as "2" is string (part movie name)
		/*
		...
		*/
		...
		/* what happens when u divide by 0.
		 if int get exception, if double or float, result is infinity
		 */
		double num = 1.0 / 0;
