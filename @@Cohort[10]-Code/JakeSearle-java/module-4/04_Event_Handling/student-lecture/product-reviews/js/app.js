...
reviewDesc.addEventListener('click', (event) => {
  changeDescription(event.target)           // call our function and pass it the element that experienced the event
})
...
function changeDescription(reviewDesc){
  ...
  const textBox = reviewDesc.nextElementSibling;   // get a reference to element we want to change
