...
<<<<<<< HEAD
		...
		PlayingCard cardTwo = new PlayingCard("Hearts", 5);   //instantiate a 5 of Hearts
		cardTwo.showCard();
		
		System.out.println("-------------------------------------");
		
		PlayingCard thirdCard = new PlayingCard("Club", 8, "8-ball", "circular");
		thirdCard.showCard();
		
		System.out.println("-------------------------------------");
		
		System.out.println("Color in card 2 is: " + cardTwo.getColor());
		System.out.println("Image in card 3 is: " + thirdCard.getImage());
		thirdCard.setImage("Mickey Mouse");
		System.out.println("Image in card 3 is: " + thirdCard.getImage());  
    }
=======
		PlayingCard aCard = new PlayingCard(); // instantiate a default playing card
