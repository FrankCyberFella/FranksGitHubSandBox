 ...
 * @return the faceUp
 */
public boolean isFaceUp() {              //get method for a boolean is called "isName" rather than get
	return faceUp;
}
...
// method to convert PlayingCard to a String
...
// equals() compares to PlayingCards
