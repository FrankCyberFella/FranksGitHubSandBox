...
//		datatype				content/initial-value		
		...
		Cow			Bessie  = new Cow();					//super class may be used to define objects of subclass 
		Chicken 	FogHorn = new Chicken();				//super class may be used to define objects of subclass 
