 ...
 * 
 * The temperature parameter is an int.  The temperatureUnit param is 
 * either a string of either F or C (not case sensitive).  includeUnit is a
 * boolean that will
 * concantenate the unit type to the convertedTemp.  It is set to 
 * [includeUnit]=false so 
 * you will have to make it true in order for it to appear.  
 * The method will return an int with an added string if instructed.  
 */
