...
<<<<<<< HEAD
		...
		PlayingCard card3 = new PlayingCard("CLUBS", 8, "8-ball", "circular"); //instantiate a round 8 clubs with an 8-ball
		card3.showCard();
		System.out.println("------------------------");
		System.out.println("Color in card2 is: " + card2.getColor());
		System.out.println("Image of card3 is: " + card3.getImage());
