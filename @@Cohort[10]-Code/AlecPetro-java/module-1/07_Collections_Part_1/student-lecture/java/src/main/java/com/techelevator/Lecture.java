...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		// To degine one: List<datatype-to-be-stored> name = new ArrayList<datatype-to-be-stored>();
		
		List<String> names = new ArrayList<String>(); // empty ArrayList of Strings
		
		names.add("Frodo"); // .add() - add methods to the ArrayList
		names.add("Sam");
		names.add("Pippin");
		names.add("Merry");
		names.add("Gandalf");
		...
		for(int i = 0; i < names.size(); i++) {
			System.out.println(names.get(i)); // .get() - retrieve the element at a given index
		}
		...
		// 				  (cant't start anywhere but the beginning;
		//				  can't stop anywhere but the end
		//				  can't skip elements)
		
		// Let's loop through names again, but this time using a for-each loop
		    							// for each name in names
		for(String anElement : names) { // every time through the loop anElement will be assigned an element in names
		...
		priorities.offer("Clean the dishes");	// add an element to the end
		priorities.offer("Wash the counters"); 	// add an element to the end
		priorities.offer("Sweep the floor"); 	// add an element to the end
		priorities.offer("Scrub the floor");	// add an element to the end
		...
		//////////////////// 
		browserStack.push("http://www.google.com");			// add element at the top
		browserStack.push("http://www.cnn.com");			// add element at the top
		browserStack.push("http://www.google.com");			// add element at the top
		browserStack.push("http://www.techelevator.com");	// add element at the top
		browserStack.push("http://www.si.com");				// add element at the top
