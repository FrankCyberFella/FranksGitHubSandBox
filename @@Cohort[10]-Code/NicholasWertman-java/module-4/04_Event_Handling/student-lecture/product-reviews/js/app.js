...
reviewDesc.addEventListener('click'), (event) => {
  changeDescription(event.target) //call fxn passing it to element that experienced event
}
...
const textBox = reviewDesc.nextElementSibling;  // get a reference to element change
         // remove the do not display
reviewDesc.innerText = textBox.value;
textBox.classList.remove('d-none');    
textBox.classList.add('d-none');    

// get a reference to the element we need to change 
}
