...
<template>
    <div class="main">
        ...
        <div class="well-display">
            <div class="well">
                <span class="amount">{{ averageRating }}</span>     <!--calling averageRating method to get a value -->
                Average Rating
            </div>
...
export default {
    ...
    computed: {
        ...
        numberOfOneStarReviews(vm) {
            return vm.numberOfReviews(vm.reviews, 1);     //call numberOfReviews method and passing the array of reviews and a number
        },
