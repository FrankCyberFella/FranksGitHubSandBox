 ...
 * Function to determine whether or not it is summer during a 
 * given month and given hemisphere
 * 
 * @param {number} month the month as a number 
 * @param {number} day the day as a number with a default 
 * value of 1
 * @param {string} hemisphere the hemisphere, either northern
 * or southern, default value of 'northern'
 * @returns {boolean} false if the parameters given aren't summer in a given region
 */
 ...
 */
 ...
 return setOfAddresses.map((address) => {
