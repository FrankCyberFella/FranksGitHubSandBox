...
// Annotation is a direction to the compiler --> they all start with an @ sign

@Override  // annotation --> tells the compiler, make sure I am overriding an existing method
...
//No @Override is necessary because the superclass does not have a equals that takes a PlayingCard as a parameter
//equals() ---> compare two PlayingCards

public boolean equals(PlayingCard otherCard) {
	if (this.value == otherCard.value
		&& this.suit.equals(otherCard.suit)) {	//use .equals to compare Strings 
		return true;
	}
	return false;
}
