...
<<<<<<< HEAD
		Scanner keyBoard = new Scanner(System.in);		// Defining a Scanner object to access the keyboard
		
		int aNumber = 0; 								// Variable to hold the keyboard input
		int anotherNumber = 0;
		double pctg = 0.0;
		double result;
		...
		System.out.println("Please enter a number");	// A prompt for people to use
		...
		System.out.println("Please enter a percentage as .nnnn");	// A prompt for people to use
		aLine = keyBoard.nextLine();					// get a line from keyboard and put it in variable aLine
		pctg = Double.parseDouble(aLine);	
		
		aNumber += anotherNumber;
		result = aNumber * pctg;
		
		System.out.println("The number you typed incremented by 1 is: " + aNumber++);
