...
public class Exercises {
	...
	public String extraEnd(String str) {
		String finalTwo = str.substring(str.length() - 2, str.length());
...
//			//if (str.contains("x") && str "x" + 1) {
//				return false;
//			}
//			if ((str.indexOf("xx") > str.indexOf("x")) || str.contains("xx")) {
//				return true;
//			}
//		}
		return false;
