...
public class NotificationController {
	 ...
	 * 
	 * get the form variables from the request body on a POST
	 * 
	 * TYPE CONVERSION
	 * ---------------
	 ...
	 * 
	 * 					form variable name||the name you want it to be
	 *     @RequestParam(name="first_name") String firstName ...
	 */
	@RequestMapping(path="/notificationSignupInput", method=RequestMethod.POST)
	public String processNotificationSignupSubmission(@RequestParam String firstName,	// want the form variable called firstName
													 @RequestParam String lastName,		// want the form variable called lastName
													 @RequestParam String emailAddress,	// want the form variable called emailAddress
													 @RequestParam int age) 			// want the form variable called age
																// don't need to parse from string here 
															 throws FileNotFoundException, IOException {
		
		//Use the model to update/insert the parameter data from the View
		 ...
		 * "redirect:" is treated as an HTTP resource and **NOT** a logical view name (.jsp). */
