...
<form:form action="${mailingListSignUpUrl}" method="POST" modelAttribute="SignUp">
        ...
        <div>
        	...
        	<form:input  path="name"  class="form-control"/>	<!-- name = identify variable in model backing form -->
        ...
        <div>
            <input type="submit" value="Sign Me Up!"/>	<!-- all variables placed in response body -->
        </div>
</form:form>
</section>
