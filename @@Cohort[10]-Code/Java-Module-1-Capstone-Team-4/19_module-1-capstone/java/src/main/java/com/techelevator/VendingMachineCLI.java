...
//	}
	...
	public void displayInventory() {
		...
		Set<String> slotKeys = inventory.keySet();
		
		for (String aSlot : slotKeys) {
			System.out.println(aSlot + " " + inventory.get(aSlot).seeName() + " " + inventory.get(aSlot).getPrice() + " " + inventory.get(aSlot).getType() + " Quantity: " + inventory.get(aSlot).getProducts().size());
		}
	}
