...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		float piF = 3.1416F; //use the F (datatype indicator) to tell Java it is a float
		...
		*/
				...
				String fullName = "Tyler James Klinger";
		...
		*/
				...
				String fullName2 = fullName + " Esquire";
		...
		*/
				...
				System.out.println("1,000,000,000 * 3" + 1,000,000,000 * 3)L;
				
//Needs to be made a Long with L because ints cannot be 3 billion
		/*
