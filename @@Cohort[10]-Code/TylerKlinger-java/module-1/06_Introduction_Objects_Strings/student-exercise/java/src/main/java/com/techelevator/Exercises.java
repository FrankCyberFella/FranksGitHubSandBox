...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		/*the second target point is not returned, but the one before
		 * (0, 2) will actually return (0, 1)
		 * (0, 2) and (2, 4) will return <<>>
		 */
	...
	public String theEnd(String str, boolean front) {
		...
		String character1 = str.charAt(0) + "";
		String character2 = str.charAt(str.length()-1) + "";
	...
	public String twoChar(String str, int index) {
		...
		String character = str.substring(0, 2);
