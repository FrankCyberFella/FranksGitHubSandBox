...
<<<<<<< HEAD
//define the data members of the class, which are located within the braces
	private String suit;
	...
	//default constructor -- assigns default values to data of class
...
//the keyword "this" indicates a member in the object that's being processed
		//can also change name of value to this. isn't necessary
		this.suit = suit;
		determineColor(suit);
		this.value = value;
		image = value + " " + suit;
	...
	//constructor to create card with suit, value, image and shape
	...
	//restrict usage to members of class
