...
<<<<<<< HEAD
		PlayingCard aCard = new PlayingCard(); //instantiate default playing card
		
		aCard.showCard();// run ShowCard using current object PlayingCard
		System.out.println("-----------------------------------------");
