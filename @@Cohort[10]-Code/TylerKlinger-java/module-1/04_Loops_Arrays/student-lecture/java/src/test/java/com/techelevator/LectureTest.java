...
public class LectureTest {
    ...
    Lecture exercises = new Lecture();// gives us access to all the data and methods in this class
    
    @Test
    public void testReturnArray() {				// object-with-code.method-to-test(any-parms-for-the-method)
    ...
    } // 		no-msg,expect, method - default JUnit message 
