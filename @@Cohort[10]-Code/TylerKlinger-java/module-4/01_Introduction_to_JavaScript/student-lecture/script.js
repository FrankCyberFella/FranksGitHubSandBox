...
function variables() {
  ...
  let daysPerMonth = 30;
  console.log('There are ${daysPerWeek} in a month');
...
function stringFunctions(value) {
  ...
  console.log('${substr(value, 2, 3)}'//start-index, length
  console.log('substring(value, 2, 3) - ${value.substring(2, 3)}')//start-index, length
...
function arrayFunction() {
  ...
  stooges.push("Shemp"); //add element to the end of array
  console.table(stooges);

  stooges.unshift("Curly Joe"); // add element to start of array
  console.table(stooges);

  stooges.splice(3,0, "Groucho", "Chico", "Harpo"); //add element to middle
  console.table(stooges);
