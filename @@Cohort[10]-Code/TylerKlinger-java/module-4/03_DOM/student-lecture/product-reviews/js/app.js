...
pageTitle.querySelector('.name').innerText = name; // get to the element with the class .name and set the text to name variable
/**
...
reviews.forEach((aReview) => {
  const reviewDiv = document.createElement('div');//creates new div
  reviewDiv.setAttribute('class', 'review'); // adds class to new div; 'class' is the class, and 'review' is the class name
  const paraElem = document.createElement('p');
  paraElem.innerText = aReview.review;
  reviewDiv.appendChild(paraElem);
