...
public class ProductController {
	...
	public String handleRootPath(HttpServletRequest request) {//Receives request from server
		request.setAttribute("productList", getProducts());//Creates an entry in the request with whatever getProducts() returns
	...
	//the Model is ArrayList in this example, but can be other things
