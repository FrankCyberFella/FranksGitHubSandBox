...
public class NotificationController {
	 ...
	 * 
	 * get the form variable from the request body on a POST
	 * 
	 * TYPE CONVERSION
	 * ---------------
	 ...
	 *                 form variable name    the name you want to call it
	 *     @RequestParam(name="first_name") String firstName ...
	 */
	@RequestMapping(path="/notificationSignupInput", method=RequestMethod.POST)
	public String processNotificationSignupSubmission(@RequestParam String firstName,   // form variable called firstName
													 @RequestParam String lastName,     // form variable called lastName
													 @RequestParam String emailAddress, // form variable called emailAddress
													 @RequestParam int age)             // form variable called age
		 ...
		 * "redirect:" is treated as an HTTP resource (a URL) and **NOT** a logical view name (.jsp). */
