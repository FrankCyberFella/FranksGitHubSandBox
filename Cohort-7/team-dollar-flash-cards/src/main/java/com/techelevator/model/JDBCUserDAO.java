...
public class JDBCUserDAO implements UserDAO {
	...
	@Override
	public void saveUser(String emailAddress, String userName, String password, String role)
		...
		jdbcTemplate.update(
				"INSERT INTO app_user(email_address, user_name, password, salt, role) VALUES (?, ?, ?, ?, ?)",
				emailAddress, userName, hashedPassword, saltString, role);
	}
