    ...
    public class ValidationTests
    {
        ...
        */
        ...
        public void Diff21()
        {
            ...
            Assert.AreEqual(31, exercises.Diff21(-10), "Input: Diff21 (-10)");
        }
        ...
        public void HasTeen()
        {
            ...
            Assert.AreEqual(false, exercises.HasTeen(10, 10, 10), "Input: HasTeen (10, 10, 10)");
            Assert.AreEqual(false, exercises.HasTeen(20, 20, 20), "Input: HasTeen (20, 20, 20)");
        }
